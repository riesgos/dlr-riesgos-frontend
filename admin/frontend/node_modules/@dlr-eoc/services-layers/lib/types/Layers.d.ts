...
export declare const WmtsLayertype = "wmts";
export declare const XyzLayertype = "xyz";
export declare const GeojsonLayertype = "geojson";
export declare const KmlLayertype = "kml";
...
export declare type TRasterLayertype = typeof WmsLayertype | typeof WmtsLayertype | typeof XyzLayertype | typeof TmsLayertype | typeof CustomLayertype;
 ...
 */
export declare class Layer implements ILayerOptions {
    name: string;
    id: string;
    type: TLayertype;
    opacity: number;
...
export declare class RasterLayer extends Layer implements IRasterLayerOptions {
    type: TRasterLayertype;
    url: string;
    subdomains?: Array<string>;
    params?: IRasterLayerParams;
...
export declare class VectorLayer extends Layer implements IVectorLayerOptions {
    type: TVectorLayertype;
    /** data: geojson data */
    data?: any;
    url?: string;
...
export declare class CustomLayer<T = any> extends Layer implements ICustomLayerOptions<T> {
    type: string;
    custom_layer: T;
