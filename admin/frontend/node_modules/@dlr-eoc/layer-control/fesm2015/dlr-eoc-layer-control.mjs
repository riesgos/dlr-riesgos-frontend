...
class LayerentryGroupComponent {
    ...
    ngOnInit() {
        ...
        if (!((_a = this.group) === null || _a === void 0 ? void 0 : _a.action)) {
    ...
    checkClassHide(layer) {
        var _a;
        const hasHide = ((_a = layer === null || layer === void 0 ? void 0 : layer.cssClass) === null || _a === void 0 ? void 0 : _a.includes('hide')) || false;
        return !hasHide;
    }
    getLayerName(group) {
...
class LayerControlComponent {
    ...
    checkClassHide(layerOrGroup) {
        var _a;
        const hasHide = ((_a = layerOrGroup === null || layerOrGroup === void 0 ? void 0 : layerOrGroup.cssClass) === null || _a === void 0 ? void 0 : _a.includes('hide')) || false;
        return !hasHide;
    }
}
