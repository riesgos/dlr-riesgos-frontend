...
import {
    isRiesgosResolvedRefProduct,
    isRiesgosUnresolvedRefProduct,
    isRiesgosValueProduct,
    RiesgosProduct,
    RiesgosProductResolved,
} from 'src/app/riesgos/riesgos.state';
...
export class DataService {
    ...
    ): Observable<RiesgosProductResolved[]> {
    ...
    resolveReference(
        ...
        if (
            isRiesgosValueProduct(product) ||
            isRiesgosResolvedRefProduct(product)
        ) {
            return of(product);
