import { RasterLayer, WmsLayer, WmtsLayer } from '@dlr-eoc/services-layers';

class OsmTileLayer extends RasterLayer {
    constructor(options) {
...
class OpenSeaMap extends RasterLayer {
    constructor(options) {
        const defaultOptions = {
            name: 'OpenSeaMap',
...
class EocLitemap extends WmsLayer {
    constructor(options) {
        const defaultOptions = {
            name: 'EOC Litemap',
...
class EocLitemapTile extends WmtsLayer {
    constructor(options) {
        const defaultOptions = {
...
class EocLiteoverlayTile extends WmtsLayer {
    constructor(options) {
        const defaultOptions = {
...
class EocBasemapTile extends WmtsLayer {
    constructor(options) {
        const defaultOptions = {
...
class EocBaseoverlayTile extends WmtsLayer {
    constructor(options) {
        const defaultOptions = {
...
class BlueMarbleTile extends WmtsLayer {
    constructor(options) {
        const defaultOptions = {
...
class WorldReliefBwTile extends WmtsLayer {
    constructor(options) {
        const defaultOptions = {
...
class HillshadeTile extends WmtsLayer {
    constructor(options) {
        const defaultOptions = {
            name: 'Hillshade Tile',
...
export { BlueMarbleTile, EocBasemapTile, EocBaseoverlayTile, EocLitemap, EocLitemapTile, EocLiteoverlayTile, HillshadeTile, OpenSeaMap, OsmTileLayer, WorldReliefBwTile };
//# sourceMappingURL=dlr-eoc-base-layers-raster.mjs.map
