...
export declare type WMS_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/wms' | 'http://schemas.opengis.net/wms/1.1.1' | 'http://schemas.opengis.net/wms/1.1.0';
export declare type WFS_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/wfs';
export declare type WCS_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/wcs';
export declare type WPS_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/wps';
export declare type CSW_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/csw';
export declare type WMTS_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/wmts';
export declare type GML_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/gml';
export declare type KML_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/kml';
export declare type GeoTIFF_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/geotiff';
export declare type GMLJP2_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/gmljp2';
export declare type GMLCOV_Offering = 'http://www.opengis.net/spec/owc-geojson/1.0/req/gmlcov';
