...
export class AshfallExposureEcuador implements MappableProductAugmenter {
  appliesTo(product: RiesgosProduct): boolean {
    return product.id === 'ashfallExposureEcuador';
  }
...
export class AshfallExposureProvider implements WizardableStepAugmenter {
  appliesTo(step: RiesgosStep): boolean {
    return step.step.id === 'AshfallExposureEcuador';
  }
