...
export declare class WmtsLayer extends RasterLayer implements IWmtsOptions {
    type: 'wmts';
    params: IWmtsParams;
    /** check if the service supports this tilesize */
    tileSize?: number;
...
export declare const isWmtsLayer: (layer: Layer) => layer is WmtsLayer;
...
export declare class WmsLayer extends RasterLayer implements IWmsOptions {
    type: 'wms';
    params: IWmsParams;
    /** check if the service supports this tilesize */
    tileSize?: number;
...
export declare const isWmsLayer: (layer: Layer) => layer is WmsLayer;
